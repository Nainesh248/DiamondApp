...
public class BasicDiamondCalc extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_diamond_calc);
    ...
    private void load_bannerAd_fb() {
        fbAdView = new com.facebook.ads.AdView(BasicDiamondCalc.this, fburl, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
    ...
    public void googRewardedVideoAdleadshow(){
        ...
        rewardedAd.show(BasicDiamondCalc.this,adCallback);
        load_RewardedVideoAd_admob();
    }
