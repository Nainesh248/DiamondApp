package com.adsum.freediamond.config;
/**
...
import com.adsum.freediamond.reciver.ConnectivityReceiver;
...
//            showDialog(activity, activity.getResources().getString(R.string.msg_NO_INTERNET_RESPOND));
    ...
    public static ProgressDialog createProgressBar(Context context,
        ...
        if (pd == null) {
            ...
            drawable.setColorFilter(ContextCompat.getColor(context, R.color.appcolor),
