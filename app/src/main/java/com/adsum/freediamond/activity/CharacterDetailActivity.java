...
public class CharacterDetailActivity extends AppCompatActivity {
    ImageView back;
    TextView topic_right,topic_left,heading,topic_caroline;
    Button btn_left,btn_right,btn_caroline;
    String topic,detail;
    int image;
    ImageView img_left,img_right,img_caroline;
    CardView cv_left,cv_right,cv_caro;
    String side;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_caro=(CardView)findViewById(R.id.cv_caroline);
        ...
        btn_caroline=(Button)findViewById(R.id.btn_caroline);

        topic_left=(TextView)findViewById(R.id.txt_lefttopic);
        topic_right=(TextView)findViewById(R.id.txt_rightopic);
        topic_caroline=(TextView)findViewById(R.id.txt_caroline);
    ...
    private void init() {
        try {
            ...
            if (side.equalsIgnoreCase(Constants._true)){
                ...
                cv_caro.setVisibility(View.INVISIBLE);
                img_left.setImageResource(image);
                topic_left.setText(detail);
                btn_left.setText(topic);


            }else if(side.equalsIgnoreCase(Constants._false)){
                ...
                cv_left.setVisibility(View.INVISIBLE);
                cv_right.setVisibility(View.INVISIBLE);
                cv_caro.setVisibility(View.VISIBLE);
                img_caroline.setImageResource(image);
                topic_caroline.setText(detail);
                btn_caroline.setText(topic);
    ...
    private void load_bannerAd_fb() {
        fbAdView = new com.facebook.ads.AdView(CharacterDetailActivity.this, fburl, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
